...
// Import Controllers (CAPITALIZED to match your files)
...
router.post('/add-equipment', upload.single('image'), equipmentController.addEquipment);
router.put('/edit-equipment/:id', upload.single('image'), equipmentController.editEquipment);
